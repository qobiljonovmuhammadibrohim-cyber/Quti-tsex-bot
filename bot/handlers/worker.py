...
async def tiger_soni(m: Message, state: FSMContext):
    ...
    await m.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="📫 Adyol qoqish uchun",   callback_data="tdest_adyol_qoqish_uchun")],
            [InlineKeyboardButton(text="📬 Pastel qoqish uchun",  callback_data="tdest_pastel_qoqish_uchun")],
...
async def tiger_dest(cb: CallbackQuery, state: FSMContext, db: AsyncSession):
    ...
    dest_labels = {
        ...
        "adyol_qoqish_uchun":  "Adyol qoqish",
        "pastel_qoqish_uchun": "Pastel qoqish",
